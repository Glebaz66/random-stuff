...
class Hamburger {
   ...
   */
  addTopping(topping) {
    !this._toppings.includes(topping) ? this._toppings.push(topping) : this._toppings;
  }
  ...
  removeTopping(topping) {
    return this._toppings = this._toppings.filter(elem => elem !== topping);
  }
  ...
  calculatePrice() {
    ...
    this._toppings.reduce((acc, price) => acc + Hamburger.TOPPINGS[price].price, 0);
  ...
  calculateCalories() {
    ...
    this._toppings.reduce((acc, calories) => acc + Hamburger.TOPPINGS[calories].calories, 0);
  }
}
